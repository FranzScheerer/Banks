...
von zur Zeit über 140 Methoden zur Berechnung der Pr&uuml;fziffer innerhalb
...
Die Berechnungsmethoden wurden zuletzt in 2018 geändert.
<p>
...
<ul>
Auf Kundenfrage habe ich die Software umgeschrieben, so dass sie mit den Versionen 5 bis 8 eingesetzt werden kann.
 
<li><h3>peter.baral@medienwerkstatt- September 2016</h3>
<pre>
Hallo Herr Scheerer,

wir müssen in naher Zukunft sämtliche unsere Web-Software welche jetzt noch unter PHP 7.3 und 7.4 läuft 
auf die neuere Version 8.0 umstellen, da Version 7.x das Support-Ende erreicht hat.

Nun ist mir aufgefallen, dass BLZKontoCheck.php unter PHP 8 nicht mehr läuft. Auf den ersten Blick sieht es 
danach aus, dass die alte {}-Syntax für Array Indizes  nicht mehr erlaubt ist - und durch  [] ersetzt werden muss.
(Fehler u.a. Fatal error: Array and string offset access syntax with curly braces is no longer supported in blzkontocheck.php on line 160)

Haben Sie schon eine auf PHP 8 angepasste neue Version? 

Schöne Feiertage und alles Gute fürs kommende Jahr.
--
Peter Baral       
medienwerkstatt.de 
...
<hr>Franz Scheerer, Dotzheimer Straße 122, 65197 Wiesbaden, Tel. 0611 168 93 98<br> 
